          ...
          <div className="text-center relative">
            ...
            <motion.h1
              ...
              className={`text-6xl font-bold mb-8 bg-clip-text text-transparent ${
                isDarkMode 
                  ? 'bg-gradient-to-r from-primary-300 via-primary-400 to-primary-300' 
            ...
            <motion.div
              ...
              className="w-64 h-1.5 mx-auto overflow-hidden rounded-full bg-gradient-to-r from-primary-400 via-primary-500 to-primary-600"
            >
              <motion.div
                initial={{ x: "-100%" }}
                animate={{ x: "100%" }}
